    ...
    <div class="h-full">
            ...
            <div class="container mx-auto h-full flex justify-center items-center px-4 sm:px-8 md:px-12 lg:px-20">
                <div ref="hero" class="content">
                    <h1 class="text-white text-2xl mb-4 md:text-4xl lg:text-5xl font-bold" v-animate-onscroll.repeat="'animated fadeIn'" style="text-shadow: 1px 1px 3px rgba(0,0,0,0.2);">Panone <span class="text-red-600">Bulk Oil Importers</span> Limited</h1>
...
.section__hero {
    background-image: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url("../assets/imgs/PANONE-14.jpg");

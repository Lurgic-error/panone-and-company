    ...
    <div class="h-full">
            ...
            <div class="container mx-auto h-full flex justify-center items-center px-4 sm:px-8 md:px-12 lg:px-20">
                <div ref="hero" class="content">
                    <h1 style="text-shadow: 1px 1px 3px rgba(0,0,0,0.2);" class="text-white text-2xl mb-4 md:text-4xl lg:text-5xl" v-animate-onscroll.repeat="'animated fadeIn'">Panone Bakeries</h1>
                    <p style="text-shadow: 1px 1px 3px rgba(0,0,0,0.2);" class="text-white md:leading-loose mb-4" v-animate-onscroll.repeat="{down: 'animated fadeUp', up: 'animated fadeDown' }">
